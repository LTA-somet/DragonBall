...
namespace XXX.UI.Popup
{
    public class BasePopupManager : MonoBehaviour
    {
        ...
        [SerializeField] private PopupBuy _popupBuyPrefab;
        private IPopup _popupBuyHandle;
        private void Start()
        {
            //if(Instance != null)
            //{
        ...
        public void ShowPopupBuy(GameObject goj)
        {
            ShowPopup(_popupBuyPrefab, ref _popupBuyHandle, null);
        }
