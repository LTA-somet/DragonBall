...
public class AIControl : MonoBehaviour
{
    ...
    [Header("speed")]
    public float speedMove = 2, speedJump = 50;
    [Header("damagedHealthy")]
    public int damagedHit = 2;
    public int damagedKick = 2;
    public int damagedKick2 = 5;
    public int damagedSuperHit = 15;
    public int damagedShoot = 4;
    [Header("power")]
    ...
    void Update()
    {
        ...
        if (!isDamaged)
        {
            ...
            if (transform.position.y +0.5 < playerScript.transform.position.y && isGround)
            {
                Debug.Log("canJump");
                jump = true;
            }
    ...
    private void AIManager()
    {
        ...
        if (distancePE > 9)
        {
            //if (attackCooldown > 0&& isStart==false)
            //{
    ...
    private void SpecicalAttack()
    {
        ...
        timeAttack = Random.Range(2f, 4f); // Thời gian chờ ngẫu nhiên
    }
    ...
    private void Attack()
    {
        ...
        timeAttack = Random.Range(1f, 2f); // Thời gian chờ ngẫu nhiên
    }
